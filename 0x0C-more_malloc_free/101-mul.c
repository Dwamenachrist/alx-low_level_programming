#include "main.h"
   ...
   /**
    * _print – This would move a string one place to the left and prints the string
    * @str: Move string
...
/**
* mul – this multiplies a char with a string and places the answer into dest
* @n: a char to multiply
